...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%% separate features according to their types 
...
sample_keep_indices1 = ~(isnan(Censored) | isnan(Survival)); 
Features    =   Features(sample_keep_indices1, :); 
Survival    =   Survival(sample_keep_indices1); 
Censored    =   Censored(sample_keep_indices1); 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% normalize mRNA and protein features 
features_mRNA_protein_cov   = diag(cov(features_mRNA_protein))';
features_mRNA_protein = (features_mRNA_protein - mean(features_mRNA_protein, 1));
